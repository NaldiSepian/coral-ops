  ...
  const getNavItems = (role: string | null) => {
    if (role === "Supervisor") {
      ...
      return [
        ...
        {
          label: "SPK Penggajian",
          type: "dropdown",
          items: [
            { href: "/views/manager/bwm/preferensi", label: "Preferensi" },
            { href: "/views/manager/bwm/penugasan", label: "Perhitungan" },
            { href: "/views/manager/bwm/gaji", label: "Gaji Teknisi" },
          ]
        },
      ];
      ...
      return [
        ...
        { href: "/views/teknisi/gaji", label: "Gaji", type: "link" },
      ];
    }
    return [];
  };
