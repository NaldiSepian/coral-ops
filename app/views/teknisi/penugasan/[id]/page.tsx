  ...
  return (
    <>
      ...
      <ProgressDialog
        ...
        existingReports={assignment.laporan_progres?.filter(r => r.pelapor_id === userId).length || 0}
        approvedReports={assignment.laporan_progres?.filter(r => r.pelapor_id === userId && r.status_validasi === "Disetujui").length || 0}
        userId={userId}
